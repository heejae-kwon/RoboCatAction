...
public:
	...
	virtual void	ProcessPacket( InputMemoryBitStream& inInputStream, const SocketAddress& inFromAddress ) override;
      ...
      void SetRoboCatToId(RoboCat* inRoboCat, int inPlayerId);
			RoboCat*	GetRoboCatFromId( int inPlayerId ) const;
...
private:
	...
	using IntToRoboCat= unordered_map< int, RoboCat* >;
	IntToRoboCat			mPlayerIdToRoboCatMap;
