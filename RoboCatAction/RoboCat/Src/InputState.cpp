...
bool InputState::Write( OutputMemoryBitStream& inOutputStream ) const
{
	...
	inOutputStream.Write( mIsShootingHyperYarn );
	inOutputStream.Write( mIsShootingBallOfYarn );
...
bool InputState::Read( InputMemoryBitStream& inInputStream )
{
	...
	inInputStream.Read( mIsShootingHyperYarn );
	inInputStream.Read( mIsShootingBallOfYarn );
