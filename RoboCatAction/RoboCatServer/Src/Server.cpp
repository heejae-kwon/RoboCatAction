...
Server::Server()
{
	...
	GameObjectRegistry::sInstance->RegisterCreationFunction( 'HYPY', HyperYarnServer::StaticCreate );
	GameObjectRegistry::sInstance->RegisterCreationFunction( 'BOYN', BallOfYarnServer::StaticCreate );
